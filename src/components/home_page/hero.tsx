    ...
    <section className="container mx-auto ">
      <div className="flex min-h-[250px] md:min-h-[350px] flex-col gap-8 md:gap-10  items-center justify-center rounded-2xl bg-card">
        <div className="flex flex-col gap-2 text-center px-4">
          <h1 className="text-2xl  font-semibold leading-tight tracking-tight capitalize ">
            Post a detailed ad — let tutors find you or apply
          </h1>
          <h2 className="text-base md:text-lg font-normal leading-normal ">
            Describe your needs (subject, level, schedule) and sit back while
            qualified tutors reach out or apply to your job.
          </h2>
        </div>
