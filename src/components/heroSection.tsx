  ...
  return (
    <>
      <main className="overflow-hidden [--color-primary-foreground:var(--color-white)] [--color-primary:var(--color-green-600)]">
        <HeroHeader />
        <section>
          <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-25 lg:pt-35">
            <div className="relative z-10 mx-auto max-w-4xl text-center">
              <TextEffect
                preset="fade-in-blur"
                speedSegment={0.3}
                as="h1"
                className="text-balance text-5xl font-medium md:text-6xl capitalize"
              >
              ...
              >
                Connect with experienced, verified tutors and view their
                qualifications to help your child succeed.
              </TextEffect>
              ...
              >
                <div className="flex flex-col items-center justify-center gap-2 md:flex-row">
                  ...
                  >
                    <Link href="/tutors">
                      <span className="text-nowrap">Find a Tutor</span>
                    </Link>
                  </Button>
                </div>
                ...
                <div
                  aria-hidden
                  className="bg-radial from-primary/50 dark:from-primary/25 relative mx-auto mt-32 max-w-3xl to-transparent to-55% text-left"
                >
